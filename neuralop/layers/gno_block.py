...
from .integral_transform import IntegralTransform, EqIntegralTransform
...
class EqGNOBlock(nn.Module):
    def __init__(self,
        ...
        # Create integral transform module
        self.integral_transform = EqIntegralTransform(
            channel_mlp=self.channel_mlp,
            transform_type=transform_type,
            use_torch_scatter=use_torch_scatter_reduce
        )
